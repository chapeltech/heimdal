...
%configure \
    ...
    --with-berkeley-db \
    --with-capng \
    --with-hdbdir=%{_localstatedir}/heimdal \
    --with-microhttpd=no \
    --with-openldap=no \
    --with-sqlite3=/usr \
    ...
    --localstatedir=%{_localstatedir}/heimdal \
...
%changelog
* Mon Aug 10 2026 Roland C. Dowdeswell <elric@imrryr.org> - 7.99.1-0.1.20260810.e0ee5cada
- Package upstream Heimdal master with the private Asgard layout.

* Sat Aug 08 2026 Roland C. Dowdeswell <elric@imrryr.org> - 7.99.1-0.1.20260808.a68a4073b
- Package the rebased Asgard Heimdal snapshot.

* Thu Aug 06 2026 Roland C. Dowdeswell <elric@imrryr.org> - 7.99.1-0.1.20260804.fa92377c
